...
| 구성 요소 | 역할 요약 | 상세 문서 |
| :---: | :--- | :---: |
| 🖥️ **관리자 PC** | 서버 내장 · 좌석 현황 · 회원 · 주문 · 매출 관리 · 채팅 응답 | [📄 바로가기](docs/ADMIN.md) |
| 💻 **사용자 PC** | 로그인 · 남은시간 표시 · 음식 주문 · 관리자 문의 | [📄 바로가기](docs/USER_PC.md) |
| 🏧 **키오스크** | 무인 충전 · 좌석 확인 · 카카오페이 · 네이버페이 결제 | [📄 바로가기](docs/KIOSK.md) |
